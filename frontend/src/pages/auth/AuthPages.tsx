...
function Brand() {
  return <Link to="/" className="inline-flex items-center gap-3"><div className="grid h-10 w-10 place-items-center rounded-lg bg-brand-600 text-sm font-bold text-white shadow-sm ring-1 ring-white/50">V</div><span className="font-display text-xl font-bold tracking-tight text-ink-900 dark:text-white">Vantora CRM</span></Link>;
}
